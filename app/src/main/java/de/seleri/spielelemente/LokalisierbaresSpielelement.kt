...
abstract class LokalisierbaresSpielelement(
    open val id: Int,
    open val localizations: MutableMap<Sprachen, String> // enthält zu allen Sprachen-Enum-Einträgen den jeweiligen Kartentext/Namen
) {
    /**
    ...
    companion object {
        ...
        fun fromEingabe(
            ...
            // für alle Sprachen: Speichert die Bezeichnung sowohl in der entsprechenden Sprache als auch in OG, oder setzt "".
        ...
        fun fromYaml(
            ...
            // Unterschied zu fromEingabe(): die Map enthält nur die ausgelesenen Sprachen, auch wenn es mehr Enum-Einträge gibt.
