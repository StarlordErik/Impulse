...
const val TEST_KARTE_1_YAML: String =
    """  - ID: 1
    Text:
      DE: ""
...
const val TEST_KARTE_2_YAML: String =
    """  - ID: 2
    Text:
      DE: "^ß´\tü+\nöä#<,.-°!\"§$ %&/()=?`Ü*ÖÄ'>;:_²³{[]}\\@€~|"
      EN: ""
...
class KartenTest {
    ...
    fun `Test eingabeToKarte() - Konvertierung von Kartentext zu Karte`() {
        ...
        assertEquals(TEST_KARTE_1.localizedTexte[Sprachen.DE], karte1.localizedTexte[Sprachen.DE])
        assertEquals(TEST_KARTE_1.localizedTexte[Sprachen.EN], karte1.localizedTexte[Sprachen.EN])
        assertEquals(TEST_KARTE_1.localizedTexte, karte1.localizedTexte)
        ...
        assertEquals(TEST_KARTE_2.localizedTexte[Sprachen.DE], karte2.localizedTexte[Sprachen.DE])
        assertEquals(TEST_KARTE_2.localizedTexte[Sprachen.EN], karte2.localizedTexte[Sprachen.EN])
        assertEquals(TEST_KARTE_2.localizedTexte, karte2.localizedTexte)
