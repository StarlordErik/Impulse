...
fun dummyLocalizations() = mutableMapOf(Sprachen.OG to DUMMY_OG, Sprachen.DE to DUMMY_DE, Sprachen.EN to null)

fun dummyLokalisierbaresSpielelement() = DummyLokalisierbaresSpielelement(DUMMY_ID, dummyLocalizations())
